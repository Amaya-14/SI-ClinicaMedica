...
class Datatable extends Component
{
    ...
    protected function makeButtonsCfg()
    {
        ...
        $printBtn = [
            ...
            'titleAttr' => 'Imprimir los registro en la tabla',
        ...
        $excelBtn = [
            ...
            'titleAttr' => 'Exportar a Excel los registro en la tabla',
            'exportOptions' => ['columns' => $colSelector],
        ];
        ...
        $pdfBtn = [
            ...
            'titleAttr' => 'Exportar a PDF los registro en la tabla',
            'exportOptions' => ['columns' => $colSelector],
        ];

        $download = [
            'className' => 'btn-color',
            'text' => '<i class="">Descargar</i>',
            'titleAttr' => 'Descargar listado completo',
            'exportOptions' => ['columns' => $colSelector],
        ];
        ...
        return [
            ...
            'buttons' => [$lengthBtn, $printBtn, $excelBtn, $pdfBtn, $download],
        ];
    }
